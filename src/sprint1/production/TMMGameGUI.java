...
class TMMGameGUIFrame extends JFrame {
    ...
    public TMMGameGUIFrame() {
        ...
        URL imageUrl=NMMGameGUI.class.getResource("/threeBoard.png");
...
public class TMMGameGUI {

    Board threeMenMorrisBoard=new Board(3);
//    threeMenMorrisBoard.setupThreeBoard();
    TMMGame smmGame = new TMMGame();

    TMMGameGUIFrame nmmGameGUIFrame = new TMMGameGUIFrame();
